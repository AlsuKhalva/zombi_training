...
def test_add_contact(app):
    ...
    user = Contact(first_name="aaa", last_name="aaa", email="kaka@mail.ru", day="10",
                               month="April", year="1990", notes="1", homephone="12399", mobilephone="12345",
                       workphone="123456", secondaryphone="212121")
