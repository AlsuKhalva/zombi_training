...
class Contacts(unittest.TestCase):
    ...
    def test_contacts(self):
        ...
        self.contact_form(wd, Group(first_name="aaa", middle_name="aaaaaaa", last_name="aaa", company="aa", company_address="hdhdh", phone="99999999", mobil="999999999", email="kaka@mail.ru", day="10",
